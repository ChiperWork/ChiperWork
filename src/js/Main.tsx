...
const Main = () => {
  ...
  const titleTemplate = unseenMsgsTotal ? `(${unseenMsgsTotal}) %s | ChiperWork` : '%s | ChiperWork';
  const defaultTitle = unseenMsgsTotal ? `(${unseenMsgsTotal}) ChiperWork` : 'ChiperWork';
    ...
    <div className="flex justify-center">
      <section className="flex w-full max-w-screen-xl justify-between relative">
        ...
        <Helmet titleTemplate={titleTemplate} defaultTitle={defaultTitle}>
          ...
          <meta property="og:image" content="./chiperconnects.png" />
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:image" content="./chiperconnects.png" />
        </Helmet>
