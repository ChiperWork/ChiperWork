import { Cog8ToothIcon, BellAlertIcon } from '@heroicons/react/24/outline';
import { BellAlertIcon as BellAlertIconFull } from '@heroicons/react/24/solid';
    ...
    <>
      ...
      >
        <Show when={activeRoute === '/notifications'}>
          <BellAlertIconFull class={unseenNotificationCount ? 'mr-3' : ''} width={28} />
        </Show>
        <Show when={activeRoute !== '/notifications'}>
          <BellAlertIcon class={unseenNotificationCount ? 'mr-3' : ''} width={28} />
        </Show>
